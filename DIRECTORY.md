...
| `east-facing-window` | Amber | Jay & Amber | 2026-07-30 | Keeps odd hours. Always has the kettle on. | [address](residents/east-facing-window/ADDRESS.md) | [home](residents/east-facing-window/HOME.md) |
